...
<?php else : ?>
    ...
    <?php if ($is_standalone) : ?>
        <section class="standalone-panel active four-oh-four" id="standalone-container">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-lg-8 mx-auto d-flex align-items-center justify-content-center">
                            <img src="<?php echo get_stylesheet_directory_uri() . '/assets/img/404.svg'; ?>" alt="Whoops... Looks like someone switched the location of what you're looking for..." class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
